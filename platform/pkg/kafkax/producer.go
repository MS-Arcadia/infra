// Package kafkax wraps segmentio/kafka-go with the platform's conventions:
// acks=all producers, per-topic dead-letter routing, bounded retries with
// backoff, and OpenTelemetry context propagated through message headers.
package kafkax
