...
// FromContext returns the context's logger, enriched with the current trace and
// correlation identifiers. It never returns nil.
...
// TraceID returns the current trace identifier, or "" when not sampled.
